...
sub scan_symbols {
    ...
    # This function scans $TEXT for non alphanumeric tokens, like COMMA, MINUS, etc.
    ...
    if (${$text_r} =~ /^([,+*|%#&\^;(){}])/ #Matches tokens: COMMA, PLUS, STAR, VERTICAL_BAR, PERCENT_SIGN, HASH, AMPERSAND, CIRCUMFLEX, SEMICOLON, PAR_OPEN, PAR_CLOSE, CURLY_OPEN, CURLY_CLOSE
